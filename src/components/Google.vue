  ...
  <div>
    <div class="main">
      ...
      <div class="flex-start-box icon-box">
        <div class="icon-app">
          <img src="https://dapv7y4era0s5.cloudfront.net/ludoup/mobileb/icon.png" alt="" class="pict">
        </div>
        <div class="app-info">
      ...
      <div class="flex-start-box app-show-box">
        <div class="show-pict-box">
          <img src="https://dapv7y4era0s5.cloudfront.net/ludoup/mobileb/img_1.png" alt="" class="show-pict">
          <img src="https://dapv7y4era0s5.cloudfront.net/ludoup/mobileb/img_2.png" alt="" class="show-pict">
          <img src="https://dapv7y4era0s5.cloudfront.net/ludoup/mobileb/img_3.png" alt="" class="show-pict">
          <img src="https://dapv7y4era0s5.cloudfront.net/ludoup/mobileb/img_4.png" alt="" class="show-pict">
        </div>
      </div>
