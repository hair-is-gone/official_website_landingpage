  ...
  methods: {
    ...
    changePict: function(msg){
      ...
      if(changeIndex <= 0){
        ...
        imgDiv.src = `https://dapv7y4era0s5.cloudfront.net/jackpot/mobile/image_${changeIndex}.png`
      }
    },
    showDialog: function(id){
      ...
      let imgDiv = document.getElementById("show-pict-big")
      imgDiv.src = `https://dapv7y4era0s5.cloudfront.net/jackpot/mobile/image_${id}.png`
    },
