...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.pjc.prcjjc.gl9" + "&refer=" + document.referrer);
