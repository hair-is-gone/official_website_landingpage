...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.looping.crazydisco.oudl" + "&refer=" + document.referrer);
