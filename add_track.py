...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.cstnot.tierbutcard" + "&refer=" + document.referrer);
