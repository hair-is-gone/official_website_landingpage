...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.blindtrm.busato" + "&refer=" + document.referrer);
