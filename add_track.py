...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.temnovap.mineslte" + "&refer=" + document.referrer);
