...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.tmitsu.paradox" + "&refer=" + document.referrer);
