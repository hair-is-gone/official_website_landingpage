...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.mistaesta.d1ce" + "&refer=" + document.referrer);
