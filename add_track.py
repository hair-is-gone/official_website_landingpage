...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.jlmajor.ahshots" + "&refer=" + document.referrer);
