...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.vitalemon.rangeen.bubble4" + "&refer=" + document.referrer);
