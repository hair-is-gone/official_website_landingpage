...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.cocomot.tpcard3" + "&refer=" + document.referrer);
