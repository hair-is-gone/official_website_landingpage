...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.bethe.silver.ludo" + "&refer=" + document.referrer);
