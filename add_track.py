...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.feelink.linkpoko" + "&refer=" + document.referrer);
