...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.firebalu.bahuno" + "&refer=" + document.referrer);
