...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.betaftk.ludodice" + "&refer=" + document.referrer);
