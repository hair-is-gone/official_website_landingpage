...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.mugha.fishingbro" + "&refer=" + document.referrer);
