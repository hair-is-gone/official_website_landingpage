...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.yono.ludo.sadness.hwa" + "&refer=" + document.referrer);
