...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.ju3wzdir8y.mcabaa0f" + "&refer=" + document.referrer);
