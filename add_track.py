...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.legendnd.balloon.matching" + "&refer=" + document.referrer);
