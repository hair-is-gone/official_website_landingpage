...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.coins.dozer.ace.ha" + "&refer=" + document.referrer);
