...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.tpcloudy.fkbili" + "&refer=" + document.referrer);
