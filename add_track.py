...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.sandstrm.candysour" + "&refer=" + document.referrer);
