...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.oheated.bakeryl" + "&refer=" + document.referrer);
