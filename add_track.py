...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.candy.crush.cash.ha" + "&refer=" + document.referrer);
