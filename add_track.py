...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.nt37.aviatoral" + "&refer=" + document.referrer);
