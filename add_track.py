...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.eurs.nami.bubble" + "&refer=" + document.referrer);
