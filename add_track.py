...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.teenpatti.toyooota.supra" + "&refer=" + document.referrer);
