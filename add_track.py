...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.nin300.tenludo" + "&refer=" + document.referrer);
