...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.last3num.ldou" + "&refer=" + document.referrer);
