...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.candy.boxbox.m3" + "&refer=" + document.referrer);
