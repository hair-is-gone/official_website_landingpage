...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.ludo.club.cash.ha" + "&refer=" + document.referrer);
