...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.teenpatti.million.ha" + "&refer=" + document.referrer);
