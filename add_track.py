...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.fresh5.ckpad.fishing" + "&refer=" + document.referrer);
