...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.rubincon.greenarc.bubble" + "&refer=" + document.referrer);
