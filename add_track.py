...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.irongate.geneludo" + "&refer=" + document.referrer);
