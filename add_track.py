...
xmlhttpInit.send("action=load_index" + "&page=" + encodeURIComponent(window.location.href) + "&chn=" + "com.cricket.champion.ccha" + "&refer=" + document.referrer);
